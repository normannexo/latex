...
%Ab hier kommt ihr Text%
 ...
 \begin{enumerate}
 \item
 Es gilt $n^2 > n + 1$ für alle $n\ge2.$\\
 Induktionsanfang: Sei $n_0=2$. Dann gilt $2^2>2+1\Rightarrow4>3$\\\\
 Induktionsannahme: Für ein $n\ge2$ gilt $n^2>n+1$\\\\
 ...
 \begin{eqnarray*}
 	...
 	&>&n+2.
 \end{eqnarray*}
 Mit dem Prinzip der vollständigen Induktion folgt, dass $n^2>n+1$ für alle $n\in\mathbb{N},n\ge2$ gilt.
\item
Es gilt $n^2 \ge 2n + 3$ für alle $n\ge3.$\\
 Induktionsanfang: Sei $n_0=3$. Dann gilt $3^2\ge6+3\Rightarrow9>9$\\\\
 Induktionsannahme: Für ein $n\ge3$ gilt $n^2\ge2n+3$\\\\
 Induktionsschritt: Zu zeigen ist
 \[
 ...
 \begin{eqnarray*}
 	...
 	&>&2n+5.
 \end{eqnarray*}
 Mit dem Prinzip der vollständigen Induktion folgt, dass $n^2>2n+3$ für alle $n\in\mathbb{N},n\ge3$ gilt.
 \end{enumerate}
\section*{Aufgabe 1.4}
\begin{enumerate}
\item
...
\begin{enumerate}
\item
Sei $f$ definiert durch $f(n)=1$ für alle $n\in\mathbb{N}$, wenn $n$ ungerade, und $f(n)=\frac{n}{2}$ für alle $n\in\mathbb{N}$, wenn $n$ gerade. Dann ist $f$ surjektiv, da ganz $\mathbb{N}$ in der Bildmenge enthalten ist, und 1 wird unendlich oft getroffen, da alle ungeraden Zahlen auf 1 abgebildet werden.
\item
...
\section*{Aufgabe 1.6}
Sei $A\in M_{mn}(\mathbb{K})$ eine Matrix, sodass $X A = 0\in M_{mn}(\mathbb{K})$ für alle Matrizen $X\in M_{mm}(\mathbb{K})$. Dann gilt insbesondere: $E_{ii}A = \begin{pmatrix}
0 & \cdots & 0 \\
0 & \cdots & 0 \\
\end{pmatrix}
$
...
%Hiernach also nicht mehr ändern%
\end{document}